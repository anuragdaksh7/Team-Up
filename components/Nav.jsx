    ...
    return (
        <div className="flex  justify-between px-[50px] lg:px-[200px] items-baseline py-4">
            ...
            <div className="flex gap-[10px] sm:gap-[30px] text-xs sm:text-lg font-normal sm:font-semibold ">
                <Link className="hover:scale-105 duration-200" href="/">Home</Link>
                <Link className="hover:scale-105 duration-200" href="/">About</Link>
                <Link className="hover:scale-105 duration-200" href="/">Features</Link>
                <Link className="hover:scale-105 duration-200" href="/">GitHub</Link>
            </div>
        </div>
    )
}